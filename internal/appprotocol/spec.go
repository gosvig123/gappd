...
var Commands = []CommandSpec{
	...
	{ID: "meetings.generateLiveActions", Mode: CommandModeRequest, Input: typeOf[MeetingShowInput](), Output: typeOf[LiveActionsResponse](), Args: []CommandArg{lit("app"), lit("meetings"), lit("generate-live-actions"), field("id"), lit("--json")}},
