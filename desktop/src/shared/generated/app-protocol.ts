...
import type { ConfigResponse, ConfigUseManagedLocalAIInput, ConfigUsePiInput, DevicesResponse, EmptyInput, MeetingDeleteInput, MeetingDeleteResponse, MeetingResponse, MeetingShowInput, MeetingsResponse, ProcessingDrainInput, ProcessingDrainResponse, RecordStartInput, RecordingEvent, RecoverStaleRecordingsResponse } from './contracts'
...
export const APP_COMMANDS = {
  ...
  'config.usePi': { mode: 'request', args: (input: ConfigUsePiInput) => ['app', 'config', 'use-pi', '--provider', String(input.provider), '--model', String(input.model)], env: [], terminal: [] },
