...
export const MEETING_UPLOAD_CONSENT_TEXT =
  ...
  'sync automatically, with a background check each minute. Gappd remembers this consent securely ' +
  'on this Mac and resumes sync after app restarts. Turning sync off or reconnecting the upload ' +
  'account clears consent. Gappd Cloud and any AI client you authorize can read it. ' +
