...
function permissionBody(error: string, isPermissionError: boolean) {
  ...
  return <>{error}<div>Open System Settings registers Gappd first, then opens Screen &amp; System Audio Recording or Microphone. Enable Gappd, then try again. Screen &amp; System Audio changes may require quitting and reopening the app before retrying.</div></>
}
