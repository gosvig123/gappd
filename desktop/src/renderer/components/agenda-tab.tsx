...
import { agendaChipLabel, agendaStateForEvent, agendaStateForMeeting, type AgendaState } from '../lib/agenda-status'
import type { AppView } from '../lib/app-view'
import './agenda-tab.css'
...
export function MeetingAgendaChip({ view, meetingId, onOpen }: { view: AppView; meetingId: string; onOpen?: () => void }) {
...
export function EventAgendaChip({ view, event }: { view: AppView; event: CalendarEventSummary }) {
 ...
 */
export function AgendaPane({ view, meetingId, onOpenSettings }: { view: AppView; meetingId: string; onOpenSettings: () => void }) {
  ...
  return (
    <div className="app-agenda-pane">
      <p className="app-agenda-source">
